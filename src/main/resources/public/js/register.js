		function validate_username(){
			...
			if(username.value == ""){
				...
				name_ele.innerHTML="<font color='green'>¡Ì Valid username</font>";
				return true;
			}
		}
		function validate_password(){
			...
			if(password.value==""){
				...
				password_ele.innerHTML="<font color='green'>¡Ì Valid password</font>";
				return true;
			}
		...
		function validate_address(){
			...
			if(address.value==""){
				...
				address_ele.innerHTML="<font color='green'>¡Ì Valid</font>";
				return true;
			}
		...
		function confirm_passwords(){
			...
			if(confirm_password.value == ""){
				...
				if(password.value != confirm_password.value){
					...
					pw_ele.innerHTML="<font color='green'>¡Ì Password confirmed</font>";
					return true;
				}
			}
		}
		...
		function validate_tel(){
			...
			if(tel.value == ""){
				...
				if(!patrn.exec(tel.value)){
					...
					tel_ele.innerHTML="<font color='green'>¡Ì Valid</font>";
					return true;
				}
			}
		...
		function validate_email(){
			...
			if(email.value == ""){
				...
				if(!patrn.test(email.value)){
					...
					email_ele.innerHTML="<font color='green'>¡Ì Valid</font>";
					return true;
				}
			}
		}
